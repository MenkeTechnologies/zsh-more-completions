#compdef agat_sq_rfam_analyzer.pl
# Documentation: https://agat.readthedocs.io/en/latest/tools/agat_sq_rfam_analyzer.html
# AGAT: summarize Rfam features in a GFF/GTF
