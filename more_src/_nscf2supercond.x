#compdef nscf2supercond.x
# Documentation: https://github.com/QEF/q-e/blob/master/EPW/src/utilities/nscf2supercond.f90
# nscf2supercond.x - QE EPW utility: extract nscf data for superconductivity calculations; standard QE command-line parser
