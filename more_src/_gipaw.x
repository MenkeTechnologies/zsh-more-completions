#compdef gipaw.x
# Documentation: https://github.com/dceresoli/qe-gipaw/blob/master/src/gipaw_main.f90
# gipaw.x - QE-GIPAW: NMR/EPR magnetic response via GIPAW; standard QE command-line parser
