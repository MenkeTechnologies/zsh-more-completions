...
@test 'more_src has _a11ywatch' {
    assert "$xsrc/_a11ywatch" is_file
}
...
@test 'more_src has _add-skill' {
    assert "$xsrc/_add-skill" is_file
}
...
@test 'more_src has _agency-swarm' {
    assert "$xsrc/_agency-swarm" is_file
}
@test 'more_src has _agent-browser' {
    assert "$xsrc/_agent-browser" is_file
}
@test 'more_src has _agent-cli' {
    assert "$xsrc/_agent-cli" is_file
}
...
@test 'more_src has _agent-protocol' {
    assert "$xsrc/_agent-protocol" is_file
}
...
@test 'more_src has _agy' {
    assert "$xsrc/_agy" is_file
}
@test 'more_src has _ai-claude' {
    assert "$xsrc/_ai-claude" is_file
}
@test 'more_src has _ai-codex' {
    assert "$xsrc/_ai-codex" is_file
}
@test 'more_src has _ai-costs' {
    assert "$xsrc/_ai-costs" is_file
}
@test 'more_src has _ai-explain' {
    assert "$xsrc/_ai-explain" is_file
}
@test 'more_src has _ai-gemini' {
    assert "$xsrc/_ai-gemini" is_file
}
@test 'more_src has _ai-git' {
    assert "$xsrc/_ai-git" is_file
}
...
@test 'more_src has _ai-renamer' {
    assert "$xsrc/_ai-renamer" is_file
}
@test 'more_src has _ai-shell' {
    assert "$xsrc/_ai-shell" is_file
}
@test 'more_src has _ai-status' {
    assert "$xsrc/_ai-status" is_file
}
...
@test 'more_src has _aiderdesk-extensions' {
    assert "$xsrc/_aiderdesk-extensions" is_file
}
...
@test 'more_src has _anthropic-cli' {
    assert "$xsrc/_anthropic-cli" is_file
}
...
@test 'more_src has _arcade' {
    assert "$xsrc/_arcade" is_file
}
@test 'more_src has _arcade-mcp' {
    assert "$xsrc/_arcade-mcp" is_file
}
@test 'more_src has _arcane-cli' {
    assert "$xsrc/_arcane-cli" is_file
}
...
@test 'more_src has _architect-cli' {
    assert "$xsrc/_architect-cli" is_file
}
...
@test 'more_src has _artifactory-cli' {
    assert "$xsrc/_artifactory-cli" is_file
}
...
@test 'more_src has _ast-grep-cli' {
    assert "$xsrc/_ast-grep-cli" is_file
}
...
@test 'more_src has _attempt-cli' {
    assert "$xsrc/_attempt-cli" is_file
}
...
@test 'more_src has _auggie' {
    assert "$xsrc/_auggie" is_file
}
@test 'more_src has _augment' {
    assert "$xsrc/_augment" is_file
}
...
@test 'more_src has _autocorrect-cli' {
    assert "$xsrc/_autocorrect-cli" is_file
}
...
@test 'more_src has _autogenstudio' {
    assert "$xsrc/_autogenstudio" is_file
}
@test 'more_src has _autogenstudio-cli' {
    assert "$xsrc/_autogenstudio-cli" is_file
}
@test 'more_src has _autogpt' {
    assert "$xsrc/_autogpt" is_file
}
...
@test 'more_src has _awsdac' {
    assert "$xsrc/_awsdac" is_file
}
@test 'more_src has _awsdac-mcp-server' {
    assert "$xsrc/_awsdac-mcp-server" is_file
}
...
@test 'more_src has _bd' {
    assert "$xsrc/_bd" is_file
}
@test 'more_src has _beads' {
    assert "$xsrc/_beads" is_file
}
@test 'more_src has _beads-cli' {
    assert "$xsrc/_beads-cli" is_file
}
...
@test 'more_src has _better-auth' {
    assert "$xsrc/_better-auth" is_file
}
...
@test 'more_src has _braintrust' {
    assert "$xsrc/_braintrust" is_file
}
...
@test 'more_src has _bruno-cli' {
    assert "$xsrc/_bruno-cli" is_file
}
...
@test 'more_src has _builder-dev-tools' {
    assert "$xsrc/_builder-dev-tools" is_file
}
...
@test 'more_src has _carbon-now-cli' {
    assert "$xsrc/_carbon-now-cli" is_file
}
...
@test 'more_src has _cargo-nfpm' {
    assert "$xsrc/_cargo-nfpm" is_file
}
@test 'more_src has _cargo-npm' {
    assert "$xsrc/_cargo-npm" is_file
}
...
@test 'more_src has _caveman-code' {
    assert "$xsrc/_caveman-code" is_file
}
...
@test 'more_src has _chauffeur' {
    assert "$xsrc/_chauffeur" is_file
}
...
@test 'more_src has _chronoctl' {
    assert "$xsrc/_chronoctl" is_file
}
...
@test 'more_src has _claude-flow' {
    assert "$xsrc/_claude-flow" is_file
}
...
@test 'more_src has _claudio-cli' {
    assert "$xsrc/_claudio-cli" is_file
}
...
@test 'more_src has _clearml-data' {
    assert "$xsrc/_clearml-data" is_file
}
@test 'more_src has _clearml-debug' {
    assert "$xsrc/_clearml-debug" is_file
}
@test 'more_src has _clearml-init' {
    assert "$xsrc/_clearml-init" is_file
}
@test 'more_src has _clearml-param-search' {
    assert "$xsrc/_clearml-param-search" is_file
}
@test 'more_src has _clearml-task' {
    assert "$xsrc/_clearml-task" is_file
}
...
@test 'more_src has _cli-forge' {
    assert "$xsrc/_cli-forge" is_file
}
...
@test 'more_src has _codacy' {
    assert "$xsrc/_codacy" is_file
}
@test 'more_src has _codacy-analysis-cli' {
    assert "$xsrc/_codacy-analysis-cli" is_file
}
...
@test 'more_src has _cohere-cli' {
    assert "$xsrc/_cohere-cli" is_file
}
...
@test 'more_src has _comet' {
    assert "$xsrc/_comet" is_file
}
@test 'more_src has _command-code' {
    assert "$xsrc/_command-code" is_file
}
...
@test 'more_src has _composio' {
    assert "$xsrc/_composio" is_file
}
@test 'more_src has _composio-cli' {
    assert "$xsrc/_composio-cli" is_file
}
@test 'more_src has _composio-js' {
    assert "$xsrc/_composio-js" is_file
}
@test 'more_src has _composio-js-cli' {
    assert "$xsrc/_composio-js-cli" is_file
}
...
@test 'more_src has _conductor-cli' {
    assert "$xsrc/_conductor-cli" is_file
}
@test 'more_src has _config-inspector' {
    assert "$xsrc/_config-inspector" is_file
}
...
@test 'more_src has _continue-cli' {
    assert "$xsrc/_continue-cli" is_file
}
@test 'more_src has _controlflow' {
    assert "$xsrc/_controlflow" is_file
}
...
@test 'more_src has _create-absolutejs' {
    assert "$xsrc/_create-absolutejs" is_file
}
@test 'more_src has _create-admin-platform' {
    assert "$xsrc/_create-admin-platform" is_file
}
@test 'more_src has _create-adonisjs' {
    assert "$xsrc/_create-adonisjs" is_file
}
@test 'more_src has _create-agent-chat-app' {
    assert "$xsrc/_create-agent-chat-app" is_file
}
@test 'more_src has _create-agent-docs' {
    assert "$xsrc/_create-agent-docs" is_file
}
@test 'more_src has _create-agent-express' {
    assert "$xsrc/_create-agent-express" is_file
}
@test 'more_src has _create-agent-skill' {
    assert "$xsrc/_create-agent-skill" is_file
}
@test 'more_src has _create-agentic-dev' {
    assert "$xsrc/_create-agentic-dev" is_file
}
@test 'more_src has _create-ai-agent' {
    assert "$xsrc/_create-ai-agent" is_file
}
@test 'more_src has _create-ai-agent-setup' {
    assert "$xsrc/_create-ai-agent-setup" is_file
}
@test 'more_src has _create-ai-dev-kit' {
    assert "$xsrc/_create-ai-dev-kit" is_file
}
@test 'more_src has _create-ai-fullstack' {
    assert "$xsrc/_create-ai-fullstack" is_file
}
@test 'more_src has _create-ai-pdlc-factory' {
    assert "$xsrc/_create-ai-pdlc-factory" is_file
}
@test 'more_src has _create-ai-rules' {
    assert "$xsrc/_create-ai-rules" is_file
}
@test 'more_src has _create-alfred-workflow' {
    assert "$xsrc/_create-alfred-workflow" is_file
}
@test 'more_src has _create-amplify' {
    assert "$xsrc/_create-amplify" is_file
}
@test 'more_src has _create-android-app' {
    assert "$xsrc/_create-android-app" is_file
}
@test 'more_src has _create-angular' {
    assert "$xsrc/_create-angular" is_file
}
@test 'more_src has _create-antd-app' {
    assert "$xsrc/_create-antd-app" is_file
}
@test 'more_src has _create-api-docs' {
    assert "$xsrc/_create-api-docs" is_file
}
@test 'more_src has _create-apollo-monorepo' {
    assert "$xsrc/_create-apollo-monorepo" is_file
}
@test 'more_src has _create-app' {
    assert "$xsrc/_create-app" is_file
}
@test 'more_src has _create-app-icon' {
    assert "$xsrc/_create-app-icon" is_file
}
@test 'more_src has _create-app-page' {
    assert "$xsrc/_create-app-page" is_file
}
@test 'more_src has _create-appwrite' {
    assert "$xsrc/_create-appwrite" is_file
}
@test 'more_src has _create-aptos-app' {
    assert "$xsrc/_create-aptos-app" is_file
}
@test 'more_src has _create-aragon-app' {
    assert "$xsrc/_create-aragon-app" is_file
}
...
@test 'more_src has _create-electron-foundation' {
    assert "$xsrc/_create-electron-foundation" is_file
}
...
@test 'more_src has _create-nft-app' {
    assert "$xsrc/_create-nft-app" is_file
}
...
@test 'more_src has _create-nocdn-app' {
    assert "$xsrc/_create-nocdn-app" is_file
}
@test 'more_src has _create-nonoise' {
    assert "$xsrc/_create-nonoise" is_file
}
@test 'more_src has _create-nosa' {
    assert "$xsrc/_create-nosa" is_file
}
@test 'more_src has _create-npm' {
    assert "$xsrc/_create-npm" is_file
}
...
@test 'more_src has _create-react-router-app' {
    assert "$xsrc/_create-react-router-app" is_file
}

@test 'more_src has _create-react-shadcn-kit' {
    assert "$xsrc/_create-react-shadcn-kit" is_file
}
@test 'more_src has _create-red-app' {
    assert "$xsrc/_create-red-app" is_file
}
...
@test 'more_src has _create-tauri-ui' {
    assert "$xsrc/_create-tauri-ui" is_file
}
@test 'more_src has _create-template-next' {
    assert "$xsrc/_create-template-next" is_file
}
@test 'more_src has _create-template-registry' {
    assert "$xsrc/_create-template-registry" is_file
}
...
@test 'more_src has _create-terraform-module' {
    assert "$xsrc/_create-terraform-module" is_file
}
@test 'more_src has _create-tessera' {
    assert "$xsrc/_create-tessera" is_file
}
@test 'more_src has _create-tezos-app' {
    assert "$xsrc/_create-tezos-app" is_file
}
@test 'more_src has _create-tina-app' {
    assert "$xsrc/_create-tina-app" is_file
}
@test 'more_src has _create-tldraw' {
    assert "$xsrc/_create-tldraw" is_file
}
@test 'more_src has _create-tomoro-app' {
    assert "$xsrc/_create-tomoro-app" is_file
}
@test 'more_src has _create-torrent' {
    assert "$xsrc/_create-torrent" is_file
}
@test 'more_src has _create-trpc-appx' {
    assert "$xsrc/_create-trpc-appx" is_file
}
...
@test 'more_src has _create-tsup' {
    assert "$xsrc/_create-tsup" is_file
}
...
@test 'more_src has _create-turbo-eth' {
    assert "$xsrc/_create-turbo-eth" is_file
}
@test 'more_src has _create-turbo-starter' {
    assert "$xsrc/_create-turbo-starter" is_file
}
@test 'more_src has _create-turbocraft' {
    assert "$xsrc/_create-turbocraft" is_file
}
@test 'more_src has _create-turborepo' {
    assert "$xsrc/_create-turborepo" is_file
}
@test 'more_src has _create-turborepo-app' {
    assert "$xsrc/_create-turborepo-app" is_file
}
@test 'more_src has _create-twosteps-app' {
    assert "$xsrc/_create-twosteps-app" is_file
}
@test 'more_src has _create-tx5dr-plugin' {
    assert "$xsrc/_create-tx5dr-plugin" is_file
}
@test 'more_src has _create-typescript-app' {
    assert "$xsrc/_create-typescript-app" is_file
}

@test 'more_src has _create-typescript-package' {
    assert "$xsrc/_create-typescript-package" is_file
}
...
@test 'more_src has _create-umi-app' {
    assert "$xsrc/_create-umi-app" is_file
}
...
@test 'more_src has _create-vue-medical' {
    assert "$xsrc/_create-vue-medical" is_file
}
@test 'more_src has _create-vue-vine' {
    assert "$xsrc/_create-vue-vine" is_file
}
@test 'more_src has _create-vuetify' {
    assert "$xsrc/_create-vuetify" is_file
}

@test 'more_src has _create-vusion' {
    assert "$xsrc/_create-vusion" is_file
}
...
@test 'more_src has _create-wdio' {
    assert "$xsrc/_create-wdio" is_file
}
@test 'more_src has _create-weapp-vite' {
    assert "$xsrc/_create-weapp-vite" is_file
}
@test 'more_src has _create-web3' {
    assert "$xsrc/_create-web3" is_file
}
@test 'more_src has _create-web3-dapp' {
    assert "$xsrc/_create-web3-dapp" is_file
}
@test 'more_src has _create-web3-frontend' {
    assert "$xsrc/_create-web3-frontend" is_file
}
@test 'more_src has _create-webbee-app' {
    assert "$xsrc/_create-webbee-app" is_file
}
@test 'more_src has _create-webpack-app' {
    assert "$xsrc/_create-webpack-app" is_file
}
@test 'more_src has _create-wolf-tui' {
    assert "$xsrc/_create-wolf-tui" is_file
}
@test 'more_src has _create-worker-app' {
    assert "$xsrc/_create-worker-app" is_file
}
@test 'more_src has _create-workflow-app' {
    assert "$xsrc/_create-workflow-app" is_file
}
@test 'more_src has _create-x402-app' {
    assert "$xsrc/_create-x402-app" is_file
}
@test 'more_src has _create-xmcp-app' {
    assert "$xsrc/_create-xmcp-app" is_file
}
@test 'more_src has _create-xtarter-app' {
    assert "$xsrc/_create-xtarter-app" is_file
}
@test 'more_src has _create-yuki-stack' {
    assert "$xsrc/_create-yuki-stack" is_file
}
@test 'more_src has _create-zksync-app' {
    assert "$xsrc/_create-zksync-app" is_file
}
@test 'more_src has _create-zs3-app' {
    assert "$xsrc/_create-zs3-app" is_file
}
@test 'more_src has _create-zudoku' {
    assert "$xsrc/_create-zudoku" is_file
}
@test 'more_src has _create-zuplo-api' {
    assert "$xsrc/_create-zuplo-api" is_file
}
...
@test 'more_src has _crewai' {
    assert "$xsrc/_crewai" is_file
}
@test 'more_src has _crewai-cli' {
    assert "$xsrc/_crewai-cli" is_file
}
...
@test 'more_src has _crush-cli' {
    assert "$xsrc/_crush-cli" is_file
}
@test 'more_src has _crwl' {
    assert "$xsrc/_crwl" is_file
}
...
@test 'more_src has _deep' {
    assert "$xsrc/_deep" is_file
}
@test 'more_src has _deepagents' {
    assert "$xsrc/_deepagents" is_file
}
@test 'more_src has _deepagents-cli' {
    assert "$xsrc/_deepagents-cli" is_file
}
@test 'more_src has _deepeval' {
    assert "$xsrc/_deepeval" is_file
}
...
@test 'more_src has _deepseek-cli' {
    assert "$xsrc/_deepseek-cli" is_file
}
...
@test 'more_src has _devin-cli' {
    assert "$xsrc/_devin-cli" is_file
}
@test 'more_src has _devist' {
    assert "$xsrc/_devist" is_file
}
@test 'more_src has _devorch' {
    assert "$xsrc/_devorch" is_file
}
...
@test 'more_src has _dify' {
    assert "$xsrc/_dify" is_file
}
@test 'more_src has _dify-cli' {
    assert "$xsrc/_dify-cli" is_file
}
...
@test 'more_src has _elevenlabs-cli' {
    assert "$xsrc/_elevenlabs-cli" is_file
}
...
@test 'more_src has _eslint-config-inspector' {
    assert "$xsrc/_eslint-config-inspector" is_file
}
...
@test 'more_src has _explain-my-error' {
    assert "$xsrc/_explain-my-error" is_file
}
...
@test 'more_src has _factory' {
    assert "$xsrc/_factory" is_file
}
@test 'more_src has _factory-cli' {
    assert "$xsrc/_factory-cli" is_file
}
...
@test 'more_src has _fastify-app' {
    assert "$xsrc/_fastify-app" is_file
}
...
@test 'more_src has _featureform' {
    assert "$xsrc/_featureform" is_file
}
...
@test 'more_src has _firecrawl' {
    assert "$xsrc/_firecrawl" is_file
}
@test 'more_src has _firecrawl-cli' {
    assert "$xsrc/_firecrawl-cli" is_file
}
...
@test 'more_src has _flowise-cli' {
    assert "$xsrc/_flowise-cli" is_file
}
...
@test 'more_src has _flyte-cli' {
    assert "$xsrc/_flyte-cli" is_file
}
...
@test 'more_src has _gooseberry' {
    assert "$xsrc/_gooseberry" is_file
}
...
@test 'more_src has _gptcache_server' {
    assert "$xsrc/_gptcache_server" is_file
}
...
@test 'more_src has _harper-cli' {
    assert "$xsrc/_harper-cli" is_file
}
...
@test 'more_src has _homeassistant-cli' {
    assert "$xsrc/_homeassistant-cli" is_file
}
...
@test 'more_src has _hopsworks-mcp' {
    assert "$xsrc/_hopsworks-mcp" is_file
}
...
@test 'more_src has _inspect' {
    assert "$xsrc/_inspect" is_file
}
@test 'more_src has _inspector-bin' {
    assert "$xsrc/_inspector-bin" is_file
}
...
@test 'more_src has _instructor' {
    assert "$xsrc/_instructor" is_file
}
@test 'more_src has _instructor-cli' {
    assert "$xsrc/_instructor-cli" is_file
}
...
@test 'more_src has _ipinfo-cli' {
    assert "$xsrc/_ipinfo-cli" is_file
}
...
@test 'more_src has _kirograph' {
    assert "$xsrc/_kirograph" is_file
}
@test 'more_src has _kirox' {
    assert "$xsrc/_kirox" is_file
}
...
@test 'more_src has _kode' {
    assert "$xsrc/_kode" is_file
}
@test 'more_src has _kode-acp' {
    assert "$xsrc/_kode-acp" is_file
}
...
@test 'more_src has _litellm' {
    assert "$xsrc/_litellm" is_file
}
@test 'more_src has _litellm-cli' {
    assert "$xsrc/_litellm-cli" is_file
}
@test 'more_src has _litellm-proxy' {
    assert "$xsrc/_litellm-proxy" is_file
}
...
@test 'more_src has _llamafactory-cli' {
    assert "$xsrc/_llamafactory-cli" is_file
}
...
@test 'more_src has _marun' {
    assert "$xsrc/_marun" is_file
}
@test 'more_src has _marvin' {
    assert "$xsrc/_marvin" is_file
}
...
@test 'more_src has _mcp-agent' {
    assert "$xsrc/_mcp-agent" is_file
}
@test 'more_src has _mcp-hub' {
    assert "$xsrc/_mcp-hub" is_file
}
...
@test 'more_src has _mem0' {
    assert "$xsrc/_mem0" is_file
}
@test 'more_src has _mem0-cli' {
    assert "$xsrc/_mem0-cli" is_file
}
...
@test 'more_src has _milvus-cli' {
    assert "$xsrc/_milvus-cli" is_file
}
...
@test 'more_src has _mistral-cli' {
    assert "$xsrc/_mistral-cli" is_file
}
...
@test 'more_src has _mobrowser' {
    assert "$xsrc/_mobrowser" is_file
}
...
@test 'more_src has _morph' {
    assert "$xsrc/_morph" is_file
}
@test 'more_src has _morph-agent' {
    assert "$xsrc/_morph-agent" is_file
}
@test 'more_src has _morph-cli' {
    assert "$xsrc/_morph-cli" is_file
}
@test 'more_src has _morph-mcp' {
    assert "$xsrc/_morph-mcp" is_file
}
@test 'more_src has _morph-setup' {
    assert "$xsrc/_morph-setup" is_file
}
@test 'more_src has _morphmcp' {
    assert "$xsrc/_morphmcp" is_file
}
...
@test 'more_src has _n8n' {
    assert "$xsrc/_n8n" is_file
}
@test 'more_src has _n8n-cli' {
    assert "$xsrc/_n8n-cli" is_file
}
...
@test 'more_src has _nemoguardrails' {
    assert "$xsrc/_nemoguardrails" is_file
}
...
@test 'more_src has _nia' {
    assert "$xsrc/_nia" is_file
}
@test 'more_src has _nia-wizard' {
    assert "$xsrc/_nia-wizard" is_file
}
...
@test 'more_src has _ohdear-cli' {
    assert "$xsrc/_ohdear-cli" is_file
}
...
@test 'more_src has _ollama-cli' {
    assert "$xsrc/_ollama-cli" is_file
}
...
@test 'more_src has _openai-cli' {
    assert "$xsrc/_openai-cli" is_file
}
...
@test 'more_src has _openapi-spec-validator' {
    assert "$xsrc/_openapi-spec-validator" is_file
}
...
@test 'more_src has _openchrome' {
    assert "$xsrc/_openchrome" is_file
}
@test 'more_src has _openchrome-mcp' {
    assert "$xsrc/_openchrome-mcp" is_file
}
@test 'more_src has _opencode-cli' {
    assert "$xsrc/_opencode-cli" is_file
}
...
@test 'more_src has _openlit-instrument' {
    assert "$xsrc/_openlit-instrument" is_file
}
...
@test 'more_src has _openswarm' {
    assert "$xsrc/_openswarm" is_file
}
@test 'more_src has _opentelemetry-bootstrap' {
    assert "$xsrc/_opentelemetry-bootstrap" is_file
}
...
@test 'more_src has _opentelemetry-instrument' {
    assert "$xsrc/_opentelemetry-instrument" is_file
}
...
@test 'more_src has _opentuicli' {
    assert "$xsrc/_opentuicli" is_file
}
...
@test 'more_src has _openzeppelin' {
    assert "$xsrc/_openzeppelin" is_file
}
@test 'more_src has _openzeppelin-contracts-migrate-imports' {
    assert "$xsrc/_openzeppelin-contracts-migrate-imports" is_file
}
...
@test 'more_src has _optimum-cli' {
    assert "$xsrc/_optimum-cli" is_file
}
...
@test 'more_src has _orchestrate' {
    assert "$xsrc/_orchestrate" is_file
}
...
@test 'more_src has _perplexity-cli' {
    assert "$xsrc/_perplexity-cli" is_file
}
...
@test 'more_src has _phi' {
    assert "$xsrc/_phi" is_file
}
@test 'more_src has _phidata' {
    assert "$xsrc/_phidata" is_file
}
@test 'more_src has _phidata-cli' {
    assert "$xsrc/_phidata-cli" is_file
}
...
@test 'more_src has _playwright-cli' {
    assert "$xsrc/_playwright-cli" is_file
}
@test 'more_src has _playwright-mcp' {
    assert "$xsrc/_playwright-mcp" is_file
}
@test 'more_src has _playwright-mcp-server' {
    assert "$xsrc/_playwright-mcp-server" is_file
}
...
@test 'more_src has _portkey_ai' {
    assert "$xsrc/_portkey_ai" is_file
}
...
@test 'more_src has _posthog-cli' {
    assert "$xsrc/_posthog-cli" is_file
}
...
@test 'more_src has _promptflow-cli' {
    assert "$xsrc/_promptflow-cli" is_file
}
...
@test 'more_src has _recon-cli' {
    assert "$xsrc/_recon-cli" is_file
}
...
@test 'more_src has _remote-agent' {
    assert "$xsrc/_remote-agent" is_file
}
@test 'more_src has _remote-coding-agent' {
    assert "$xsrc/_remote-coding-agent" is_file
}
...
@test 'more_src has _repomix-cli' {
    assert "$xsrc/_repomix-cli" is_file
}
@test 'more_src has _report-cli' {
    assert "$xsrc/_report-cli" is_file
}
...
@test 'more_src has _rust-to-npm-cli' {
    assert "$xsrc/_rust-to-npm-cli" is_file
}
...
@test 'more_src has _sagemaker-studio' {
    assert "$xsrc/_sagemaker-studio" is_file
}
@test 'more_src has _sagemaker-studio-cli' {
    assert "$xsrc/_sagemaker-studio-cli" is_file
}
...
@test 'more_src has _seldon-core-api-tester' {
    assert "$xsrc/_seldon-core-api-tester" is_file
}
@test 'more_src has _seldon-core-microservice' {
    assert "$xsrc/_seldon-core-microservice" is_file
}
@test 'more_src has _seldon-core-microservice-tester' {
    assert "$xsrc/_seldon-core-microservice-tester" is_file
}
@test 'more_src has _seldon-core-tester' {
    assert "$xsrc/_seldon-core-tester" is_file
}
...
@test 'more_src has _shai-scan' {
    assert "$xsrc/_shai-scan" is_file
}
...
@test 'more_src has _simplifyify' {
    assert "$xsrc/_simplifyify" is_file
}
...
@test 'more_src has _smolagent' {
    assert "$xsrc/_smolagent" is_file
}
...
@test 'more_src has _spec-driver' {
    assert "$xsrc/_spec-driver" is_file
}
...
@test 'more_src has _statikapi' {
    assert "$xsrc/_statikapi" is_file
}
...
@test 'more_src has _superagent' {
    assert "$xsrc/_superagent" is_file
}
@test 'more_src has _superagent-cli' {
    assert "$xsrc/_superagent-cli" is_file
}
...
@test 'more_src has _supersurkhet' {
    assert "$xsrc/_supersurkhet" is_file
}
...
@test 'more_src has _supplyscan' {
    assert "$xsrc/_supplyscan" is_file
}
...
@test 'more_src has _swarm-code' {
    assert "$xsrc/_swarm-code" is_file
}
@test 'more_src has _swarms' {
    assert "$xsrc/_swarms" is_file
}
@test 'more_src has _swarmskills' {
    assert "$xsrc/_swarmskills" is_file
}
...
@test 'more_src has _sweep-cli' {
    assert "$xsrc/_sweep-cli" is_file
}
@test 'more_src has _sweepai' {
    assert "$xsrc/_sweepai" is_file
}
@test 'more_src has _sweepai-cli' {
    assert "$xsrc/_sweepai-cli" is_file
}
...
@test 'more_src has _task-master' {
    assert "$xsrc/_task-master" is_file
}
@test 'more_src has _task-master-ai' {
    assert "$xsrc/_task-master-ai" is_file
}
@test 'more_src has _task-master-mcp' {
    assert "$xsrc/_task-master-mcp" is_file
}
...
@test 'more_src has _taskweaver' {
    assert "$xsrc/_taskweaver" is_file
}
...
@test 'more_src has _tavily' {
    assert "$xsrc/_tavily" is_file
}
@test 'more_src has _tavily-cli' {
    assert "$xsrc/_tavily-cli" is_file
}
...
@test 'more_src has _thirdweb-cli' {
    assert "$xsrc/_thirdweb-cli" is_file
}
...
@test 'more_src has _tiny-agents' {
    assert "$xsrc/_tiny-agents" is_file
}
...
@test 'more_src has _tolgee' {
    assert "$xsrc/_tolgee" is_file
}
@test 'more_src has _tolka' {
    assert "$xsrc/_tolka" is_file
}
...
@test 'more_src has _trigger' {
    assert "$xsrc/_trigger" is_file
}
@test 'more_src has _trigger-cli' {
    assert "$xsrc/_trigger-cli" is_file
}
...
@test 'more_src has _upload_theme' {
    assert "$xsrc/_upload_theme" is_file
}
...
@test 'more_src has _uptrain-add' {
    assert "$xsrc/_uptrain-add" is_file
}
...
@test 'more_src has _vibe-kanban' {
    assert "$xsrc/_vibe-kanban" is_file
}
...
@test 'more_src has _void' {
    assert "$xsrc/_void" is_file
}
@test 'more_src has _void-agent' {
    assert "$xsrc/_void-agent" is_file
}
@test 'more_src has _void-spirit' {
    assert "$xsrc/_void-spirit" is_file
}
@test 'more_src has _voidforge' {
    assert "$xsrc/_voidforge" is_file
}
...
@test 'more_src has _walkmod' {
    assert "$xsrc/_walkmod" is_file
}
@test 'more_src has _walkmod-cli' {
    assert "$xsrc/_walkmod-cli" is_file
}
...
@test 'more_src has _weave' {
    assert "$xsrc/_weave" is_file
}
@test 'more_src has _weave-cli' {
    assert "$xsrc/_weave-cli" is_file
}
...
@test 'more_src has _wxt-publish-extension' {
    assert "$xsrc/_wxt-publish-extension" is_file
}
