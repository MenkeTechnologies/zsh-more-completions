#compdef pygettext3.12.py
# Documentation: https://man.archlinux.org/search?q=pygettext3.12.py
...
arguments=(
  ...
  {-d,--default-domain}'[rename the default output file from messages.pot to name.pot.]'
  ...
  {-v,--verbose}'[print the names of the files being processed.]'
  {-V,--version}'[print the version of pygettext and exit.]'
