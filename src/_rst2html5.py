#compdef rst2html5.py
# Documentation: https://man.archlinux.org/search?q=rst2html5.py
...
arguments=(
  ...
  '--math-output[math output format (one of "MathML", "HTML"]'
  '--xml-declaration[prepend an XML declaration. (Thwarts HTML5]'
