...
# Documentation: https://man.archlinux.org/search?q=rstpep2html.py
...
arguments=(
  ...
  '--python-home[pythons home URL. Default is]'
  '--pep-home[home URL prefix for PEPs. Default is "." (current]'
  '*:filename:_files'
)
