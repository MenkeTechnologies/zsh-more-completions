#compdef rst2odt.py
# Documentation: https://man.archlinux.org/search?q=rst2odt.py
...
arguments=(
  ...
  '--stylesheet[specify a stylesheet. Default:]'
  '--odf-config-file[specify a configuration/mapping file relative to the]'
  '--cloak-email-addresses[obfuscate email addresses to confuse harvesters while]'
  '--no-cloak-email-addresses[do not obfuscate email addresses.]'
  '--table-border-thickness[specify the thickness of table borders in thousands of]'
  '--add-syntax-highlighting[add syntax highlighting in literal code blocks.]'
  '--no-syntax-highlighting[do not add syntax highlighting in literal code blocks.]'
  ...
  '--generate-oowriter-toc[generate an ODF/oowriter table of contents, not a]'
  '--custom-odt-header[specify the contents of an custom header line. See]'
  '--custom-odt-footer[specify the contents of an custom footer line. See]'
  '*:filename:_files'
)
