...
(){
    ...
    local __zsh_more_comp_dirs_last=("$1/src" "$1/more_src" "$1/more_src2" "$1/more_src3" "$1/more_src4" "$1/more_src5" "$1/more_src6" "$1/more_src7" "$1/more_src8" "$1/man_src" "$1/architecture_src")
