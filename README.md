...
A **massive** zsh completions plugin — **16,092 commands** wired into the compsys neural net. Most were auto-generated by python scripts that jacked into `--help` output and man pages, ripping completion data straight from the source. All completions have been cleaned, verified and updated with latest command options. Architecture-prefixed completions live in the `architecture_src` directory. **18,294 tests** validate every tracked completion file.

```
src/              -> 9,232 main completions
more_src/         -> 2,387 additional completions
