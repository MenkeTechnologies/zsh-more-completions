...
# Documentation: https://github.com/Mbed-TLS/mbedtls-docs/blob/b6f493df13504cf43806bc99de3ea8f6f9b18d46/tools/zsh/_ssl-opt.sh
# Reference accessed: 2026-05-21
# Verified: upstream docs at the URL above.
# Source: Mbed-TLS/mbedtls-docs (tools/zsh/_ssl-opt.sh)
